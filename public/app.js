...
function loadExtraModules(){const styles=['/labs.css','/progress.css','/business.css','/monthly.css'];styles.forEach(src=>{if(!document.querySelector(`link[href="${src}"]`)){const link=document.createElement('link');link.rel='stylesheet';link.href=src;document.head.appendChild(link)}});const scripts=['/labs.js','/progress.js','/business.js','/monthly.js'];scripts.forEach(src=>{if(!document.querySelector(`script[src="${src}"]`)){const script=document.createElement('script');script.src=src;script.defer=true;document.body.appendChild(script)}})}
